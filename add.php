     ...
     <div id="header">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td width="226">
                                <a href="general_list.aspx">回列表</a>
                            </td>
                        </tr>
                    </table>
                    <div id="header-Menu">
                        ...
                        onmouseout="MM_swapImgRestore()" /><img
                            ...
                            onclick="MM_goToURL('parent','special_edit.aspx');return document.MM_returnValue"
...
<script type="application/json" id="__browserLink_initializationData">
    {"appName":"Firefox","requestId":"e886a883c5f549cab49079fce4500e92"}
</script>
<script type="text/javascript" src="http://localhost:50191/198143240ba04cc295f31c8450fc2c4c/browserLink" async="async"></script>
<!-- End Browser Link -->
